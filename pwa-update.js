...
(function () {
  ...
  var EXPECTED_UPDATER = 'pwa-update.js?v=133';
  var EXPECTED_MANIFEST = 'manifest.json?v=109';
  var EXPECTED_STYLE = 'styles.css?v=339';
  var EXPECTED_APP = 'app.js?v=243';
  var EXPECTED_SOFT_NAV = 'soft-nav.js?v=8';
